...
void MainWindow::helpShow() {
    QMessageBox::about(this, u8"关于", " Pineapple Music| 一款精致小巧的本地音乐播放器\n"
                                       "【歌词文件说明】需要与对应歌曲MP3在同目录且同名（.lrc文件）\n"
                                       "【使用说明】\n"
                                       ...
                                       "【查看歌曲歌词】点击播放栏界面的专辑图片或点击播放栏的“词”\n"
                                       "【聊天室】在聊天室界面，输入用户昵称，在点击连接服务器按钮，输入发送的信息，点击发送按钮，即可实现实时聊天"
                                       "【网络搜索】在网络搜索界面通过输入歌词名称，点击搜索按钮即可显示搜索结果，可通过右击所选，点击下载即可将音乐下载到本地，并在本地音乐点击刷新,可显示刚刚下载的音乐\n"
