...
void Sidebar::setupContentLists() {
    ...
    localMusic_item->setIcon(QIcon("../resource/icon/音乐.svg"));
    ...
    playList_item->setIcon(QIcon("../resource/icon/歌单.svg"));
    ...
    fromNet_item->setIcon(QIcon("../resource/icon/网络歌曲.svg"));
    ...
    chatroom_item->setIcon(QIcon("../resource/icon/消息.svg"));
